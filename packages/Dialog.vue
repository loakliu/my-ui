<template>
  ...
  <transition name="dialog-fade">
    <div class="m-dialog__wrapper" v-show="visible" @click.self="handleClose">
      <div class="m-dialog" :style="{width, marginTop: top}">
        <div class="m-dialog__header">
          <slot name="title">
            <span class="m-dialog__title">{{title}}</span>
          </slot>
          <button class="m-dialog__headerbtn" @click="handleClose">
        ...
        <div class="m-dialog__footer" v-if="$slots.footer">
